...
@section('content')
    <div class="bg-white">
        <div class="container text-center mb-3">
            <h1 style="margin-top: 40px;">Uma iniciativa internacional para a promoção e educação para a Cidadania Digital</h1>
            <hr/>
            <p style="size: 0.9em; font-weight: 500; margin-top: 40px;">
                ...
                <div class="col-6">
                    <p class="text-center mt-5">
                        <a class="btn btn-primary"
                           ...
                           target="_blank"
                           style="background-color: #224a59;border-color: #224a59; margin-top: 90px;"
                        >
                            {{ __('Leia o Manifesto pela Cidadania Digital') }}
                        </a>
                    </p>
                </div>
                <div class="col-6">
                    <p class="mb-0" style="margin-top: 40px;">Realização:</p>
                    <img src="{{ url('/images/logos/atopos-logo.png') }}" alt="Atopos Logo" style="height: 12em;">
                    <img src="{{ url('/images/logos/usp-logo.png') }}" alt="USP Logo" style="height: 7em; margin-top: 17px;">
                </div>
            </div>
        </div>
    </div>
