    ...
    <div class="jumbotron bg-transparent">
        <div class="container text-center">
            ...
            <p class="text-center m-0" >
                <a href="https://34d58460-6c5d-4ec9-80bb-e7055249a338.filesusr.com/ugd/e30c33_7cc8e6a2745d4993b530e2cc4eb3dd12.pdf" target="_blank">{{ __('Leia o Manifesto da CIdadania Digital') }}</a>
            </p>
        </div>
    </div>
